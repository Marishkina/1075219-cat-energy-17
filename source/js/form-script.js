...
var catName = form.querySelector(".input__cat-name");
var weight = form.querySelector(".input__weight");
var age = form.querySelector(".input__age");
var email = form.querySelector(".input__email");
var phone = form.querySelector(".input__phone");
